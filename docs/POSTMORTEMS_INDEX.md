...
|---|---|---|---|---|---|---|
| 2026-05-09 | SPR-009 EventBus resolved — patrón H4 (event_bus_device creative_device) post-investigación F-B | Build/Compile + Documentation | ~6h totales (F-A 2.5h + F-B investigación + F-C resolución + F-C-4 docs + F-C-5 PM) | SPR-009 ✅ resolved | BOOTSTRAP §11.5-11.8, API_REFERENCE §3.5, VERSE_SYNTAX_GUIDE §1 lección 16, CHANGELOG D-A11 + nota D-A8, GLOSSARY EventBus + event(t) + Await loop, MODULES §2.1+§4.2+§11.2, SPRINTS_BACKLOG SPR-009, CONCEPT §13.3 SPR-009, TESTING_PROTOCOL §2.1+§2.3, PROMPT_TEMPLATES §12, FOLDER_STRUCTURE_TRUTH §1.1+§4+§8.2, JSON_SCHEMAS §42 (12 docs cerrados en F-C-4 + F-C-5) | [PM-SPR-009-blocked.md](postmortems/PM-SPR-009-blocked.md) |
