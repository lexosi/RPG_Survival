...
### 11.5 Plantilla `EventBusConstants.verse`

```verse
# Content/Verse/Generated/EventBusConstants.verse
# ============================================================
# AUTO-GENERATED FILE. DO NOT EDIT MANUALLY.
# Source: data/architecture/events_catalog.json
...
event_bus_module := class<concrete>:
    ...
    # Cada event(t) es signalable + awaitable + subscribable nativos.
...
"""
Generate EventPayloads_Generated.verse and EventBusConstants.verse from events_catalog.json.
Idempotent.
"""
...
BUS_OUT = "Content/Verse/Generated/EventBusConstants.verse"
...
def export_event_bus() -> None:
    ...
    lines.append("")
    lines.append("EventBus<public> : event_bus_module = event_bus_module{}")
...
# Dentro de AchievementEngine.Init()
EventBus.LevelUp.Subscribe(OnLevelUp)

# Handler con firma tipada
...
**Esperar un evento (`await`)**:

```verse
# Suspender la corutina hasta que se emita LevelUp
...
| Soporte `await` | ❌ requiere implementación custom | ✅ nativo (`event(t)` es `awaitable`) |
